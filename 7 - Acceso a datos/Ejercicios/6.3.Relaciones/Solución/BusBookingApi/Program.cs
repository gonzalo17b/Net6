...
builder.Services.AddSingleton<BusBookingApi.Clientes.Domain.IClientesService, BusBookingApi.Clientes.Domain.ClientesService>();
builder.Services.AddSingleton<BusBookingApi.Rutas.Domain.IRutasService, BusBookingApi.Rutas.Domain.RutasService>();
