...
builder.Services.AddScoped<BusBookingApi.Clientes.Domain.IClientesService, BusBookingApi.Clientes.Domain.ClientesService>();
builder.Services.AddScoped<BusBookingApi.Rutas.Domain.IRutasService, BusBookingApi.Rutas.Domain.RutasService>();
